...
public class ChessMatch {
    ...
    public ChessPiece performChessMove (ChessPosition sourcePosition, ChessPosition targetPosition) {
        ...
        if (testCheck(currentPlayer)){
            ...
            throw new ChessException("Chess Error: you can't put yourself in check");
        }
    ...
    private void validateSourcePosition(Position position) {
        ...
        if(currentPlayer != ((ChessPiece)board.piece(position)).getColor()){
            throw new ChessException("Chess Error: The chosen piece it's not yours");
        }
    ...
    private Piece makeMove(Position source, Position target) {
        ...
        if (p instanceof King && target.getColumn() == source.getColumn() + 2) {
            ...
            Position targetRook = new Position(target.getRow(), target.getColumn() - 1);
    ...
    private ChessPiece king (Color color) {
        ...
        throw new IllegalStateException("Chess Error: there is no" + color + "King on the board");
    }
